 ...
 */
final class Version20230201095731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE group_request (id INT NOT NULL, user_id INT DEFAULT NULL, date DATE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_approved BOOLEAN NOT NULL, PRIMARY KEY(id))');
