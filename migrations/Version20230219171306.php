 ...
 */
final class Version20230219171306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bet (id INT NOT NULL, event_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE betting_group (id INT NOT NULL, name VARCHAR(255) NOT NULL, user_max INT NOT NULL, cover VARCHAR(128) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, code VARCHAR(23) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE event (id INT NOT NULL, betting_group_id INT DEFAULT NULL, the_user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, finish_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, start_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, result VARCHAR(255) DEFAULT NULL, cover_image VARCHAR(128) DEFAULT NULL, PRIMARY KEY(id))');
